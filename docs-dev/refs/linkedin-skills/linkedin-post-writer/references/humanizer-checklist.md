# Humanizer Pre-Publish Checklist

Every post must pass this before the approval card is shown. If any fail, rewrite that section and re-run.

## SCRUB (delete or replace)

### Punctuation
- [ ] No em dashes (`—`) — replace with `.` or `,`
- [ ] No en dashes (`–`) — replace with `-` or `to`
- [ ] No double dashes (`--`)
- [ ] No curly quotes — convert to straight `"`
- [ ] No Oxford commas in casual posts (too tidy)

### Vocabulary (delete every instance)
- [ ] leverage
- [ ] utilize
- [ ] facilitate
- [ ] streamline
...
### Structure
- [ ] No uniform sentence length (15-22 words each)
...
- [ ] No rule-of-three lists without receipts
- [ ] No opening with a rhetorical question (on LinkedIn it reads AI)
- [ ] No closing with "What do you think?"

## ADD (human fingerprints)

- [ ] Burstiness: mix 3-word and 30-word sentences. At least one <5-word sentence per 150 words.
- [ ] ≥1 specific number per 100 words (not "many", "significant", "massive")
- [ ] ≥1 named entity (real person, company, date, city)
- [ ] ≥1 first-person sensory detail (what you saw, heard, touched)
- [ ] ≥1 contradiction or self-correction ("I thought X. I was wrong.")
- [ ] One opinion with stakes — something someone could disagree with
- [ ] One beat of vulnerability (what you got wrong, what scared you, what you don't know)

## Target scores

- OriginalityAI: under 25% AI-likelihood
