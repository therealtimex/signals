...
INSERT INTO `__new_interactions`("id", "contact_id", "org_id", "interaction_type", "direction", "summary", "is_meaningful", "occurred_at", "scope", "source", "engagement_id", "content_item_id", "content_post_id", "platform", "workflow_run_id", "metadata", "created_at") SELECT "id", "contact_id", "org_id", "interaction_type", "direction", "summary", "is_meaningful", "occurred_at", "scope", "source", "engagement_id", "content_item_id", "content_post_id", "platform", "workflow_run_id", "metadata", "created_at" FROM `interactions`;--> statement-breakpoint
...
CREATE INDEX `idx_interactions_content_post` ON `interactions` (`content_post_id`);--> statement-breakpoint
