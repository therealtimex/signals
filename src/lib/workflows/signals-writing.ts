...
export function buildWritingBriefSection(input: {
  ...
  return [
    ...
    "8. Call materialize_variant only after the server-validated audit passes. Under explicit policy include user approval evidence; do not manufacture it. Use revoke_variant_approval when the user withdraws approval.",
