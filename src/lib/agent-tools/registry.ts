...
import {
  approvePersonalityProjectionSchema,
  getPersonalityBindingSchema,
  handleApprovePersonalityProjection,
  handleGetPersonalityBinding,
  handleProposePersonalityProjection,
  handleRejectPersonalityProjection,
  handleRetryPersonalityProjection,
  handleRollbackPersonalityProjection,
  handleUnbindPersonalityProjection,
  handleUpsertPersonalityStatements,
  proposePersonalityProjectionSchema,
  rejectPersonalityProjectionSchema,
  retryPersonalityProjectionSchema,
  rollbackPersonalityProjectionSchema,
  unbindPersonalityProjectionSchema,
...
export const AGENT_TOOLS: Record<string, AgentToolDefinition> = {
  ...
  get_personality_binding: {
    name: "get_personality_binding",
    description: "Read the configured Signals workspace Personality binding, drift, source freshness, history, proposals, and RealTimeX host capability.",
    category: "content",
    schema: getPersonalityBindingSchema,
    parameters: zodToParameters(getPersonalityBindingSchema),
    execute: handleGetPersonalityBinding,
  },
  propose_personality_projection: {
    name: "propose_personality_projection",
    description: "Create an immutable, reviewable Personality projection proposal. This never approves or writes workspace files.",
    category: "content",
    schema: proposePersonalityProjectionSchema,
    parameters: zodToParameters(proposePersonalityProjectionSchema),
    execute: handleProposePersonalityProjection,
  },
  approve_personality_projection: {
    name: "approve_personality_projection",
    description: "Persist explicit thread-message approval and apply a reviewed Personality proposal through the RealTimeX transaction writer.",
    category: "content",
    schema: approvePersonalityProjectionSchema,
    parameters: zodToParameters(approvePersonalityProjectionSchema),
    execute: handleApprovePersonalityProjection,
  },
  reject_personality_projection: {
    name: "reject_personality_projection",
    description: "Reject a reviewable Personality proposal with durable user evidence. This never writes workspace files.",
    category: "content",
    schema: rejectPersonalityProjectionSchema,
    parameters: zodToParameters(rejectPersonalityProjectionSchema),
    execute: handleRejectPersonalityProjection,
  },
  retry_personality_projection: {
    name: "retry_personality_projection",
    description: "Explicitly inspect, recover, resume, or retry an approved Personality transaction using its durable attempt journal.",
    category: "content",
    schema: retryPersonalityProjectionSchema,
    parameters: zodToParameters(retryPersonalityProjectionSchema),
    execute: handleRetryPersonalityProjection,
  },
  rollback_personality_projection: {
    name: "rollback_personality_projection",
    description: "Create a reviewable proposal that restores retained historical Personality blocks into current unmanaged workspace prose.",
    category: "content",
    schema: rollbackPersonalityProjectionSchema,
    parameters: zodToParameters(rollbackPersonalityProjectionSchema),
    execute: handleRollbackPersonalityProjection,
  },
  unbind_personality_projection: {
    name: "unbind_personality_projection",
    description: "Create a reviewable proposal that removes only Signals-managed Personality blocks and preserves unmanaged workspace prose.",
    category: "content",
    schema: unbindPersonalityProjectionSchema,
    parameters: zodToParameters(unbindPersonalityProjectionSchema),
    execute: handleUnbindPersonalityProjection,
  },
  query_goals: {
    name: "query_goals",
